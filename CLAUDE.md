...
- Phase 4 "External Respondents" panel: always visible (top of page), collapsible, shows submitted/awaiting status per respondent
...
- **Pending DB migration:** `ALTER TABLE attribute ADD COLUMN IF NOT EXISTS is_ordinal boolean NOT NULL DEFAULT true;` — required for Phase 2 ordinal/nominal classification feature; run in Supabase SQL editor
