...
- `run_solver()` — 4 runs (one per constraint regime), returns all_runs array with r_squared, rse, and target_point_estimates per run; winner = lowest SSE with least-constrained tie-break
